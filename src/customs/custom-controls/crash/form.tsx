...
export default function CrashForm({
  ...
  return (
    <div className="bg-black border border-gray-600 bg-opacity-20 border-opacity-20 crash-form w-full h-45 md:w-3/4 flex rounded-md p-3 relative">
     <form
        ref={formRef}
        method="POST"
      ...
      >
        ...
        <section className="flex flex-col flex-wrap sm:flex-row sm:flex-nowrap mx-auto items-center sm:items-start lg:justify-center sm:gap-4">
          ...
          <div className="w-full sm:w-1/3 max-w-[400px] sm:max-w-none">
            <If
              condition={
                transaction == null ||
                transaction?.status == TransactionStatus.UNREGISTERED
            ...
            >
              <button
                className={`btn py-1 border-2 hover:border-red-600 text-[22px] hover:text-[24px] rounded-[20px] border-red-400 ${backgroundColor} flex flex-col px-0 text-white h-full w-full`}
              >
            ...
            >
              <button
                className={`btn border-2 text-[22px] py-1 hover:text-[24px] flex flex-col px-0 text-white h-full w-full bg-red-700 rounded-[20px] hover:bg-red-800 border-[#ffffff40] hover:border-gray-400 `}
            ...
            >
              <div className="flex flex-col w-full h-full">
                <button
                  className={`btn border-2 text-[22px] hover:text-[24px] flex flex-col px-0 text-white h-full w-full`}
