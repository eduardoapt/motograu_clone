...
export default function Navbar({
  ...
  const {soundEnabled,
        ...
        soundClick,
        playerName
        } = useContext(CrashGameContext) as any
      ...
      <div className="navbar mx-auto  my-auto sm:px-3 h-12 flex items-center w-full justify-end">
        ...
        <div className="flex items-center ml-auto gap-2">
          ...
          <div className="dropdown dropdown-end" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className="mt-2 menu b menu-compact rounded chat-container py-2 w-[280px] max-w-[300px] absolute top-[30px] right-[30px] z-10">
